...
<head>
    ...
    <link rel="stylesheet" href="<?= theme("/assets/css/custom.css", CONF_VIEW_ADMIN); ?>" />
...
<body>
    ...
    <div class="dash">
        <aside class="dash_sidebar">
            ...
            <ul class="dash_sidebar_nav">
                ...
                echo "<li class=\"dash_sidebar_nav_li\"><a class=\"icon-link\" href=\"" . url() . " \" target=\"_blank\">View site</a></li>";

                echo $nav("sign-out on_mobile", "logoff", "Exit");
                ?>
            </ul>
        </aside>
            ...
            <div class="dash_userbar">
                <div class="dash_userbar_box">
                    <div class="dash_content_box">
                        <h1 class="icon-cog transition"><a href="<?= url("/admin/dash"); ?>"><?= CONF_SITE_NAME ?> <b>Admin</b></a></h1>
                        <div class="dash_userbar_box_bar">
                            <span class="notification_center_open icon-bell" data-count="<?= url("/admin/notifications/count"); ?>" data-notify="<?= url("/admin/notifications/list"); ?>" data-url="<?= url(); ?>">0</span>
                            <span class="no_mobile icon-clock-o"><?= date("Y-m-d H:i"); ?></span>
                            <a class="no_mobile icon-sign-out" title="Sair" href="<?= url("/admin/logoff"); ?>">Exit</a>
    ...
    <script src="<?= url("/shared/admin/assets/scripts/jquery.form.js"); ?>"></script>
    <script src="<?= url("/shared/admin/assets/scripts/jquery-ui.js"); ?>"></script>
    <script src="<?= url("/shared/admin/assets/scripts/jquery.mask.js"); ?>"></script>
    <script src="<?= url("/shared/admin/assets/scripts/tinymce/tinymce.min.js"); ?>"></script>
    <script src="<?= theme("/assets/js/sweetalert.min.js", CONF_VIEW_ADMIN); ?>"></script>
