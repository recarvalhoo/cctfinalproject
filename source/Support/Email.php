...
class Email
{
    ...
    {
        if (empty($this->data)) {
            $this->message->error("Error sending, please check the data.");
            return false;
        }

        if (!is_email($this->data->recipient_email)) {
            $this->message->warning("Recipient email is not valid.");
            return false;
        }

        if (!is_email($from)) {
            $this->message->warning("The sender email is not valid.");
            return false;
        }
